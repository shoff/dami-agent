...
/// periwinkle one — the point of the strip is that a healthy service reads as healthy without
...
public sealed class RunBrush : IValueConverter
{
    ...
    private static readonly SolidColorBrush unknown = new(Color.Parse("#A0A0A0"));

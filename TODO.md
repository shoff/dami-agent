...
- [~ Codex 2026-08-24] G4 **Sessions**: multi-turn conversation with a recent window in context; start/resume/interrupt/reconnect without duplication — acceptance item 1
  - [~ Codex 2026-08-24] G4a Durable session/turn contracts + PostgreSQL store with request-id idempotency
  - [ ] G4b Session-aware turn runner + bounded recent conversation window in model context

...
| Web view at :5810/ (J3/J4) | done | conversation (SSE), live execution graph, inbox with reactions, belief ledger with correct/retract/diff actions, and the health timeline — single file, no frameworks, localhost-only |

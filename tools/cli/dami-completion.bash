...
_dami_completions()
{
    ...
    if [ "$COMP_CWORD" -eq 1 ]; then
        local verbs="inbox recent read good bad meh trace health health-log health-reject listen stats recall ask context caption chat sessions session frontier brief approvals approve deny beliefs correct retract note"

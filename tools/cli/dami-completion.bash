...
_dami_completions()
{
    ...
    if [ "$COMP_CWORD" -eq 1 ]; then
        local verbs="inbox recent read good bad meh trace health stats recall ask context caption chat sessions session frontier brief approvals approve deny beliefs correct retract note"
